...
Blockly.Arduino.base_map_light=function(){var a=Blockly.Arduino.valueToCode(this,"NUM",Blockly.Arduino.ORDER_NONE),b=Blockly.Arduino.valueToCode(this,"DMAX",Blockly.Arduino.ORDER_ATOMIC);return["map("+a+", 0, 360, 0, "+b+")",Blockly.Arduino.ORDER_NONE]};Blockly.Arduino.base_map_moisture=function(){var a=Blockly.Arduino.valueToCode(this,"NUM",Blockly.Arduino.ORDER_NONE),b=Blockly.Arduino.valueToCode(this,"DMAX",Blockly.Arduino.ORDER_ATOMIC);return["map("+a+", 0, 1024, 0, "+b+")",Blockly.Arduino.ORDER_NONE]};
Blockly.Arduino.base_map_v2=function(){var a=Blockly.Arduino.valueToCode(this,"NUM",Blockly.Arduino.ORDER_NONE),b=Blockly.Arduino.valueToCode(this,"DMAX",Blockly.Arduino.ORDER_ATOMIC),c=Blockly.Arduino.valueToCode(this,"DMAX1",Blockly.Arduino.ORDER_ATOMIC),d=Blockly.Arduino.valueToCode(this,"DMAX2",Blockly.Arduino.ORDER_ATOMIC);return["map("+a+", "+c+", "+d+", 0, "+b+")",Blockly.Arduino.ORDER_NONE]};
...
Blockly.Arduino.grove_temporature_sensor=function(){
    var a=this.getFieldValue("PIN");return["round((1/(log((float)(1023-analogRead("+a+"))*10000/analogRead("+a+"))/10000)/3975+1/298.15)-273.15)",Blockly.Arduino.ORDER_ATOMIC]};
...
Blockly.Arduino.grove_dht_read=function(){
    ...
    {
        case "h":
            c+="(int)(dht.readHumidity())"; 
        break;
        case "C":
            c+="(int)(dht.readTemperature())"; 
        break;
        case "F":
            c+="(int)(dht.readTemperature(true))";
        break;
    }
    Blockly.Arduino.definitions_["define_dht_"+b+"_"+a]="#include <DHT.h>\n#define DHTPIN "+b+"\n#define DHTTYPE DHT"+a+a+"\nDHT dht(DHTPIN, DHTTYPE);";
    Blockly.Arduino.setups_["setup_dht_"+b+"_"+a]="dht.begin();\n";
    return[c,Blockly.Arduino.ORDER_ATOMIC]
};


Blockly.Arduino.grove_display_print=function(){
    var b=Blockly.Arduino.valueToCode(this,"TEXT",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"''";Blockly.Arduino.definitions_.define_wire="#include <Wire.h>\n";
    Blockly.Arduino.definitions_.define_oled="#include <SeeedOLED.h>\n";
    Blockly.Arduino.setups_.display="Wire.begin();\n SeeedOled.init();\n SeeedOled.clearDisplay();\n SeeedOled.setNormalDisplay();\n SeeedOled.setPageMode();\n SeeedOled.setTextXY(0, 0);\n SeeedOled.setHorizontalScrollProperties(Scroll_Right,4,7,Scroll_5Frames);\n SeeedOled.activateScroll();\n";
    return "SeeedOled.putString("+b+");\n"
};
...
Blockly.Arduino.grove_oled_display_set_cursor = function() {
    var a = Blockly.Arduino.valueToCode(this, "ROW", Blockly.Arduino.ORDER_ATOMIC) || 0,
        b = Blockly.Arduino.valueToCode(this, "COL", Blockly.Arduino.ORDER_ATOMIC) || 0;
    Blockly.Arduino.definitions_.include_wire_lib = "#include <Wire.h>\n";
    Blockly.Arduino.definitions_.include_seeedoled_lib = "#include <SeeedOLED.h>\n";
    Blockly.Arduino.setups_.setup_wire_lib = "Wire.begin();\n";
    Blockly.Arduino.setups_.setup_seeedoled_lib_init = "SeeedOled.init();\n";
...
Blockly.Arduino.grove_oled_display_put = function() {
    ...
    var b = "Number" === a || "Float" === a ? Blockly.Arduino.valueToCode(this, "VALUE", Blockly.Arduino.ORDER_ATOMIC) || 0 : Blockly.Arduino.valueToCode(this, "VALUE", Blockly.Arduino.ORDER_ATOMIC) || "";
    Blockly.Arduino.definitions_.include_wire_lib = "#include <Wire.h>\n";
    Blockly.Arduino.definitions_.include_seeedoled_lib = "#include <SeeedOLED.h>\n";
    Blockly.Arduino.setups_.setup_wire_lib = "Wire.begin();\n";
...
Blockly.Arduino.grove_pir_motion_sensor=function(){var a=this.getFieldValue("PIN");Blockly.Arduino.setups_["setup_input_"+a]="pinMode("+a+", INPUT);";return["digitalRead("+a+")",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.grove_line_finder=function(){var a=this.getFieldValue("PIN");Blockly.Arduino.setups_["setup_input_"+a]="pinMode("+a+", INPUT);";return["digitalRead("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
...
Blockly.Arduino.grove_moisture_sensor=function(){return["analogRead("+this.getFieldValue("PIN")+")",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.grove_light_sensor=function(){return["analogRead("+this.getFieldValue("PIN")+")",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.grove_sound_sensor=function(){return["analogRead("+this.getFieldValue("PIN")+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.grove_bar_led=function(){var a=this.getFieldValue("PIN"),b=_get_next_pin(a),c=Blockly.Arduino.valueToCode(this,"NUM",Blockly.Arduino.ORDER_NONE)||"1000";Blockly.Arduino.definitions_.define_ledbar="#include <Grove_LED_Bar.h>\n";Blockly.Arduino.definitions_["var_ledbar_"+a]="Grove_LED_Bar bar("+b+","+a+",0);\n";Blockly.Arduino.setups_.setup_ledbar="bar.begin();\n";return"bar.setLevel("+c+");\n"};
Blockly.Arduino.grove_pir_motion_sensor=function(){return["pow(3027.4 / analogRead("+this.getFieldValue("PIN")+"), 1.2134)",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.logic={};
