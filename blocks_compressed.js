...
Blockly.Blocks.base_map = {
    ...
    init: function() {
        this.setColour(230);
        this.appendValueInput("NUM", "Number").appendField("Mapeo ").setCheck("Number");
        this.appendValueInput("DMAX", "Number").appendField("Convertir de [0-").setCheck("Number");
...
Blockly.Blocks.base_map_v2 = {
    helpUrl: "http://arduino.cc/en/Reference/map",
    init: function() {
        this.setColour(230);
        this.appendValueInput("NUM", "Number").appendField("Mapeo ").setCheck("Number");
        this.appendValueInput("DMAX1", "Number").appendField("Convertir de [").setCheck("Number");
        this.appendValueInput("DMAX2", "Number").appendField("-").setCheck("Number");
        this.appendValueInput("DMAX", "Number").appendField("] a [0-").setCheck("Number");
        this.appendDummyInput().appendField("]");
        this.setInputsInline(!0);
        this.setOutput(!0);
        this.setTooltip("Re-maps a number from [0-1024] to another.")
...
Blockly.Blocks.servo_move = {
    ...
    init: function() {
        this.setColour(190);
        this.appendDummyInput().appendField("Servo").appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
...
Blockly.Blocks.grove_led = {
    ...
    init: function() {
        this.setColour(250);
        this.appendDummyInput().appendField("LED").appendField(new Blockly.FieldImage("../media/grove/400px-LED1.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField("estado").appendField(new Blockly.FieldDropdown([
            ["HIGH", "HIGH"],
            ["LOW", "LOW"]
        ]), "STAT");
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0,
            null);
        this.setTooltip("Multicolor LED")
    }
};
...
Blockly.Blocks.grove_button = {
    ...
    init: function() {
        this.setColour(10);
        this.appendDummyInput().appendField("Botón").appendField(new Blockly.FieldImage("../media/grove/400px-Button1.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.setOutput(!0, "Boolean");
...
Blockly.Blocks.grove_relay = {
    ...
    init: function() {
        this.setColour(250);
        this.appendDummyInput().appendField("Relé").appendField(new Blockly.FieldImage("../media/grove/relay.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN").appendField("estado").appendField(new Blockly.FieldDropdown([
            ["HIGH", "HIGH"],
            ["LOW", "LOW"]
        ]), "STAT");
...
Blockly.Blocks.grove_temporature_sensor = {
    ...
    init: function() {
        this.setColour(10);
        this.appendDummyInput().appendField("Sensor Temperatura").appendField(new Blockly.FieldImage("../media/grove/temperature.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN");
        this.setOutput(!0, "Number");
...
Blockly.Blocks.grove_humidity_sensor = {
    ...
    init: function() {
        this.setColour(10);
        this.appendDummyInput().appendField("Sensor Humetat aire").appendField(new Blockly.FieldImage("../media/grove/temperature.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN");
        this.setOutput(!0, "Number");
...
Blockly.Blocks.grove_dht_read = {
    ...
    init: function() {
        this.setColour(10);
        this.appendDummyInput().appendField(new Blockly.FieldImage("../media/grove/temperature.jpg", 64, 64)).appendField("Tipo sensor").appendField(new Blockly.FieldDropdown([
            ["1", "1"],
            ["2", "2"]
        ]), "SENSOR");
        this.appendDummyInput().appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.appendDummyInput().appendField("Fenomeno").appendField(new Blockly.FieldDropdown([
            ["Humedad del aire", "h"],
            ["Temperatura", "C"]
        ]), "TYPE");
        this.setInputsInline(!0);
        this.setOutput(!0, "Number");
        this.setTooltip("The DHT sensors are made of two parts, a capacitive humidity sensor and a thermistor.")
    }
};
...
Blockly.Blocks.grove_oled_display_clear = {
    init: function() {
        this.setHelpUrl("http://wiki.seeed.cc/Grove-OLED_Display_0.96inch/");
        this.setColour(250);
        this.appendDummyInput().appendField("Pantalla").appendField(new Blockly.FieldImage("../media/grove/display.jpg", 64, 48)).appendField("Borrar");
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("An OLED monochrome 128׶4dot matrix display module with Grove 4pin I2C Interface.")
    }
};
...
Blockly.Blocks.grove_oled_display_set_cursor = {
    init: function() {
        this.setHelpUrl("http://wiki.seeed.cc/Grove-OLED_Display_0.96inch/");
        this.setColour(250);
        this.appendDummyInput().appendField("Pantalla").appendField(new Blockly.FieldImage("../media/grove/display.jpg", 64, 48));
        this.appendValueInput("ROW").setCheck("Number").appendField("Mover a XY(");
        this.appendValueInput("COL").setCheck("Number").appendField(",");
        this.appendDummyInput().appendField(")");
        this.setInputsInline(!0);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("Un módulo de pantalla matricial OLED monocromática de 128x64 puntas amb una interfiera Grove I2C de 4 pines")
    }
};
...
Blockly.Blocks.grove_oled_display_put = {
    init: function() {
        this.setHelpUrl("http://wiki.seeed.cc/Grove-OLED_Display_0.96inch/");
        this.setColour(250);
        this.appendDummyInput().appendField("Pantalla").appendField(new Blockly.FieldImage("../media/grove/display.jpg", 64, 48)).appendField("Escribe").appendField("tipo").appendField(new Blockly.FieldDropdown([
            ["int", "Number"],
            ["flotant", "Float"],
            ["cadena", "String"]
        ]), "TYPE");
...
Blockly.Blocks.grove_display_print = {
    helpUrl: "http://www.seeedstudio.com/wiki/index.php?title=GROVE_-_Starter_Bundle_V1.0b#Serial_LCD",
    init: function() {
        this.setColour(250);
        this.appendDummyInput().appendField("Pantalla").appendField(new Blockly.FieldImage("../media/grove/display.jpg", 64, 64));
        this.appendValueInput("TEXT", "String").setCheck("String").setAlign(Blockly.ALIGN_RIGHT).appendField("Mostrar");
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
        this.setTooltip("print text on an 16 character by 2 line LCD.")
    }
...
Blockly.Blocks.grove_rgb_led = {
    ...
    init: function() {
        this.setColour(130);
        this.appendDummyInput().appendField("LED Multicolor").appendField(new Blockly.FieldImage("../media/grove/chanbalelednb1.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
...
Blockly.Blocks.grove_moisture_sensor = {
    init: function() {
        this.setColour(10);
        this.appendDummyInput().appendField("Sensor de humedad del suelo").appendField(new Blockly.FieldImage("../media/grove/moisture.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.setOutput(!0, "Number");
        this.setTooltip("return number of moisture")
    }
};
...
Blockly.Blocks.grove_light_sensor = {
    ...
    init: function() {
        this.setColour(10);
        this.appendDummyInput().appendField("Sensor de luz").appendField(new Blockly.FieldImage("../media/grove/400px-Twig-Light-sensor.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN");
        this.setOutput(!0, "Number");
        this.setTooltip("Detect the light of the environment")
    }
};
Blockly.Blocks.grove_sound_sensor = {
    ...
    init: function() {
        this.setColour(10);
        this.appendDummyInput().appendField("Sensor de sonido").appendField(new Blockly.FieldImage("../media/grove/400px-Twig-Sound-sensor.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN");
        this.setOutput(!0, "Number");
        this.setTooltip("Detect the sound strength of the environment")
    }
};
Blockly.Blocks.grove_bar_led = {
    init: function() {
        this.setHelpUrl("http://www.example.com/");
        this.setColour(250);
        this.appendDummyInput().appendField("Barra de LEDS").appendField(new Blockly.FieldImage("../media/grove/ledbar.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.appendValueInput("NUM", "Number").appendField("con el valor").setCheck("Number");
        this.setInputsInline(!0);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip("")
...
Blockly.Blocks.grove_pir_motion_sensor = {
    init: function() {
        this.setColour(10);
        this.setHelpUrl("");
        this.appendDummyInput().appendField("Sensor de proximidad").appendField(new Blockly.FieldImage("../media/grove/400px-Twig-Proximity-sensor.jpg", 64, 64)).appendField("PIN#").appendField(new Blockly.FieldDropdown(profile["default"].analog), "PIN");
        this.setOutput(!0, "Number");
        this.setTooltip("")
    }
};
